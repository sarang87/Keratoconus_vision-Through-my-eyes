...
pathName_output = "/home/wickedshaman/Desktop/output_keratoconus/"
pathName_input = "/home/wickedshaman/Desktop/sample_gray_keratoconus/"
spread_factor = None
num_ghost_imgs = 3
...
if __name__ == "__main__":
    ...
    for i in range(10):    
        img_o = cv2.imread("./input_images/example.jpg")
        img_bg = cv2.imread("./input_images/example.jpg",0)
        saveImage(pathName_input,img_bg, "example.jpg" )
        img_kc = img_bg
        ...
        output_name = "skyline_keratoconus_" + str(i) + ".jpg"
